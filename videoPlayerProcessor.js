...
class VideoPlayerProcessor {
  constructor(
    ...
    this.videoData.richButtonText =
      customizedParamsJSON.richButtonText || "Read more";
    this.videoData.richButtonTextColor =
      customizedParamsJSON.richButtonTextColor;
  ...
  delayedInit = () => {
    ...
    if (isVisible || this.state.previewMode) {
      ...
      if (
        ...
        this.getVideoWrapperElement(
          this.videoData.styleIdentifier
        ).querySelector(".skeleton-loader") != null
      ) {
        this.getVideoWrapperElement(
          this.videoData.styleIdentifier
        ).querySelector(".skeleton-loader").style.display = "none";
      }
