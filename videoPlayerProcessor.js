...
var facebookIconHtml = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" id="facebook"><path fill="#1877f2" d="M1024,512C1024,229.23016,794.76978,0,512,0S0,229.23016,0,512c0,255.554,187.231,467.37012,432,505.77777V660H302V512H432V399.2C432,270.87982,508.43854,200,625.38922,200,681.40765,200,740,210,740,210V336H675.43713C611.83508,336,592,375.46667,592,415.95728V512H734L711.3,660H592v357.77777C836.769,979.37012,1024,767.554,1024,512Z"></path><path fill="#fff" d="M711.3,660,734,512H592V415.95728C592,375.46667,611.83508,336,675.43713,336H740V210s-58.59235-10-114.61078-10C508.43854,200,432,270.87982,432,399.2V512H302V660H432v357.77777a517.39619,517.39619,0,0,0,160,0V660Z"></path></svg>';

var twitterIconHtml = '<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 72 72" viewBox="0 0 72 72" id="twitter-x"><switch><g><path d="M42.5,31.2L66,6h-6L39.8,27.6L24,6H4l24.6,33.6L4,66h6l21.3-22.8L48,66h20L42.5,31.2z M12.9,10h8l38.1,52h-8L12.9,10z"></path></g></switch></svg>';

var linkedinIconHtml = '<svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 72 72" id="linkedin"><g fill="none" fill-rule="evenodd"><g><rect width="72" height="72" fill="#0077B5" rx="4"></rect><path fill="#FFF" d="M13.139 27.848h9.623V58.81h-9.623V27.848zm4.813-15.391c3.077 0 5.577 2.5 5.577 5.577 0 3.08-2.5 5.581-5.577 5.581a5.58 5.58 0 1 1 0-11.158zm10.846 15.39h9.23v4.231h.128c1.285-2.434 4.424-5 9.105-5 9.744 0 11.544 6.413 11.544 14.75V58.81h-9.617V43.753c0-3.59-.066-8.209-5-8.209-5.007 0-5.776 3.911-5.776 7.95V58.81h-9.615V27.848z"></path></g></g></svg>';

var whatsappIconHtml = '<svg fill="#25D366" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 308 308" xml:space="preserve"><g id="XMLID_468_"><path id="XMLID_469_" d="M227.904,176.981c-0.6-0.288-23.054-11.345-27.044-12.781c-1.629-0.585-3.374-1.156-5.23-1.156c-3.032,0-5.579,1.511-7.563,4.479c-2.243,3.334-9.033,11.271-11.131,13.642c-0.274,0.313-0.648,0.687-0.872,0.687c-0.201,0-3.676-1.431-4.728-1.888c-24.087-10.463-42.37-35.624-44.877-39.867c-0.358-0.61-0.373-0.887-0.376-0.887c0.088-0.323,0.898-1.135,1.316-1.554c1.223-1.21,2.548-2.805,3.83-4.348c0.607-0.731,1.215-1.463,1.812-2.153c1.86-2.164,2.688-3.844,3.648-5.79l0.503-1.011c2.344-4.657,0.342-8.587-0.305-9.856c-0.531-1.062-10.012-23.944-11.02-26.348c-2.424-5.801-5.627-8.502-10.078-8.502c-0.413,0,0,0-1.732,0.073c-2.109,0.089-13.594,1.601-18.672,4.802c-5.385,3.395-14.495,14.217-14.495,33.249c0,17.129,10.87,33.302,15.537,39.453c0.116,0.155,0.329,0.47,0.638,0.922c17.873,26.102,40.154,45.446,62.741,54.469c21.745,8.686,32.042,9.69,37.896,9.69c0.001,0,0.001,0,0.001,0c2.46,0,4.429-0.193,6.166-0.364l1.102-0.105c7.512-0.666,24.02-9.22,27.775-19.655c2.958-8.219,3.738-17.199,1.77-20.458C233.168,179.508,230.845,178.393,227.904,176.981z"/><path id="XMLID_470_" d="M156.734,0C73.318,0,5.454,67.354,5.454,150.143c0,26.777,7.166,52.988,20.741,75.928L0.212,302.716c-0.484,1.429-0.124,3.009,0.933,4.085C1.908,307.58,2.943,308,4,308c0.405,0,0.813-0.061,1.211-0.188l79.92-25.396c21.87,11.685,46.588,17.853,71.604,17.853C240.143,300.27,308,232.923,308,150.143C308,67.354,240.143,0,156.734,0zM156.734,268.994c-23.539,0-46.338-6.797-65.936-19.657c-0.659-0.433-1.424-0.655-2.194-0.655c-0.407,0-0.815,0.062-1.212,0.188l-40.035,12.726l12.924-38.129c0.418-1.234,0.209-2.595-0.561-3.647c-14.924-20.392-22.813-44.485-22.813-69.677c0-65.543,53.754-118.867,119.826-118.867c66.064,0,119.812,53.324,119.812,118.867C276.546,215.678,222.799,268.994,156.734,268.994z"/></g></svg>';

class VideoPlayerProcessor {
	constructor(params, previewMode = "", customizedParams = null, styleIdentifier = "") {
		...
		this.videoData.linkText = customizedParamsJSON.ctaText ? customizedParamsJSON.ctaText : params.ctaText;
		...
		this.videoData.richText = this.unpackTextArea(customizedParamsJSON.richText) || "undefined";
		this.videoData.richButtonText = customizedParamsJSON.richButtonText || "Read more";
		this.videoData.richButtonTextColor = customizedParamsJSON.richButtonTextColor;
		this.videoData.richTextColor = customizedParamsJSON.richTextColor;
		this.videoData.richBgColor = customizedParamsJSON.richBgColor;
		...
		let isVisible = this.elementIsVisibleInViewport(this.getVideoWrapperElement(this.videoData.styleIdentifier), false);
		if (isVisible) {
			this.init().then(() => {
				setTimeout(() => {
					let isPlayerVisible = this.elementIsVisibleInViewport(this.getCurrentVideoPlayerElement(), false);
					if (isPlayerVisible) {
						this.eventTrigger("impression");
						this.eventTrigger("start");

						this.videoData.player.addEventListener("timeupdate", (event) => {
	...
	delayedInit = () => {
		...
		if (isVisible || this.state.previewMode) {
			...
			if (this.getVideoWrapperElement(this.videoData.styleIdentifier) != null && this.getVideoWrapperElement(this.videoData.styleIdentifier).querySelector(".skeleton-loader") != null) {
				this.getVideoWrapperElement(this.videoData.styleIdentifier).querySelector(".skeleton-loader").style.display = "none";
			}
	...
	togglePlayOnViewPortVisibility = () => {
		let isVisible = this.elementIsVisibleInViewport(this.getCurrentVideoPlayerElement(), false);
	...
	addResponsive(wrapper) {
		...
		let ctaRichText = wrapper.querySelector(".cta-rich-text");
		let ctaContent = ctaHover.querySelector(".cta-content");
		let ctaRichTextContent = ctaRichText?.querySelector(".rich-text-content");
		...
		let player = wrapper.querySelector("mux-player");
		let ctaAreaOuter = wrapper.querySelector(".cta-area-outer");

		if (player.shadowRoot) {
			let mediaTheme = player.shadowRoot.querySelector("media-theme");
			if (mediaTheme) {
				// mediaTheme.style.minHeight = "480px";
				// mediaTheme.style.minWidth = "240px";
				mediaTheme.style.height = "fit-content";
				overlay.style.height = 0.89 * mediaTheme.offsetHeight + "px";
				overlay.style.width = mediaTheme.offsetWidth;

				if (ctaAreaOuter) {
					ctaAreaOuter.style.width = mediaTheme.offsetWidth;
				}
				if (overlayBackground) {
					overlayBackground.style.width = mediaTheme.offsetWidth;
					overlayBackground.style.height = mediaTheme.offsetHeight;
				}
			}
		}
	...
	async init() {
		await this.initializePlayer(this.videoData.materialId, this.videoData.styleIdentifier);
	...
	async initializeEventData() {
		...
		let sectionsObj = [];
		//round to more
		for (let i = 0; i < this.videoData.videoDurationSeconds; i = i + this.videoData.sectionDurationSeconds) {
			...
			sectionsObj[sectionsObj.length] = {
				start: i, end: end, partNumber: sectionsObj.length + 1,
			};
		}
	...
	async initializePlayer(materialId, styleIdentifier) {
		...
		return new Promise((resolve, reject) => {
			try {
				this.addWebComponentToWrapper(wrapper, this.videoData.fileLocation, this.videoData.linkText, this.videoData.playerWidth, this.videoData.playerHeight, this.videoData.ctaLayout, this.videoData.playerSound, this.videoData.useAutoDimensions);
					...
					.then(() => {
						...
						if (this.videoData.player) {
							this.videoData.player.addEventListener("play", (event) => {
								var isVisible = this.elementIsVisibleInViewport(this.getCurrentVideoPlayerElement(), false);
								if (!isVisible) {
									this.getCurrentVideoPlayerElement().pause();
								}

								if (wrapper.querySelector(".skeleton-loader") != null) {
									wrapper.querySelector(".skeleton-loader").style.display = "none";
								}

								window.addEventListener("scroll", this.togglePlayOnViewPortVisibility);

								if (cta && (this.videoData.ctaLayout === "top-right" || this.videoData.ctaLayout === "bottom-left")) {
									setTimeout(function () {
							...
							overlay.addEventListener("mouseleave", () => {
								...
								if (this.videoData.ctaShowOnHover === "t" && ctaHover && this.state.complete) {
									ctaHover.style.display = "flex";
									overlayBackground.style.display = "block";
	...
	addFullScreenListener(wrapper) {
		const scheduleFullscreenListener = () => {
			...
			if (player.shadowRoot) {
				let mediaTheme = player.shadowRoot.querySelector("media-theme");
				let mediaController = mediaTheme.shadowRoot.querySelector("media-controller");

				wrapper.addEventListener("fullscreenchange", () => {
					let customMuteIconWrapper = mediaController.querySelector("[data-custom-mute-div]");

					if (document.fullscreenElement !== null) {
						customMuteIconWrapper.style.display = "block";
						this.videoData.player.muted = false;

						let mediaCustomMuteButton = customMuteIconWrapper.querySelector("[data-custom-mute-icon]");
	...
	addMuteListeners(wrapper) {
		const scheduleMuteListener = () => {
			...
			if (player.shadowRoot) {
				...
				const mediaMuteButton = mediaController.querySelector("media-mute-button");
				if (!mediaMuteButton) {
				...
				let muteIconDiv = '<div data-custom-mute-div style="height: 35px;' + "width: 35px;" + "position: absolute;" + "top: 20px;" + "left: 20px;" + "display: none;" + "fill: white;" + 'cursor: pointer;">' + customMuteIconHTML + "</div>";

				let shadowRootStyle = document.createElement("style");
				shadowRootStyle.innerHTML = ".hidden { display: none; } .unhidden { opacity: 1; }";
				...
				const mediaCustomMuteButton = mediaController.querySelector("[data-custom-mute-icon]");
	...
	getCurrentVideoPlayerElement() {
		return document.getElementById("current-player-" + this.videoData.styleIdentifier);
	}
	...
	addWebComponentToWrapper(wrapper, playbackId, title, widthInput, heightInput, ctaLayout, soundOn, auto) {
		if (!wrapper) {
			return;
		}
		...
		let style = this.validateVideoContainerStyle(widthInput, heightInput, ctaLayout, auto);

		let playerHtml =
			'<mux-player id="current-player-' +
	...
	getCtaHTML() {
		...
		let richButtonText = this.videoData.richButtonText;
		let richButtonTextColor = this.videoData.richButtonTextColor;
		let richButtonBgColor = this.videoData.richBgColor;
		...
		let shareSocialHtml = this.getShareSocialHtml();
		...
		let ctaBgColor = "background-color: " + this.hexToRGBA(bgColor, this.convertOpacityToDecimal(opacity)) + ";";

		let sliderContentHTMLInner =
		...
		let contentSlider = supportText;
		if (ctaTaglineText) {
			contentSlider = ctaTaglineText;
		}

		if (!contentSlider) {
			contentSlider = 'Please add tagline text';
		}

		sliderContentHTMLInner =
			sliderContentHTMLInner +
			'<span class="bullet">&#8226;</span>' +
		...
		let ctaAreaInner =
			'<div class="cta-area ' + layoutPosition + '">' +
			'<div class="cta ' + layoutPosition + '" style="' + ctaBgColor + '; color:' + textColor + '">' +
			ctaBlockHTML +
			'</div>' +
			'</div>';
		...
		switch (layoutPosition) {
			case "below-video":
				richContent =
					...
					'" alt="">' +
					"</div>" +
					'<div class="rich-text-content" style="color:' + textColor + '">' +
					contentHTMLInner +
					"</div>";
				break;
		...
		let richTextBlock =
			`<div class="cta-rich-text" style="${taglineShow ? "margin-top: 32px;" : "margin-top: 12px;"}">` +
			richContent +
		...
		let ctaAreaOuter =
			`<div class="cta-area-outer"><div class="cta cta-slide-wrapper">
				${taglineShow ? sliderHTML : ''}
				${richTextBlock}
			</div></div><div class='overlayBackground'/>`;
		...
		let ctaAreaHover =
			...
			'<input class="cta-btn btn-default" type="button" data-copy-code="" style="border: 1px ' + ctaButtonColor + ' solid; background:' + ctaButtonColor + ';color: ' + ctaButtonTextColor + ';" value="' + ctaButtonText + '">' +
			'</div>' +
			'</div>';

		return '<a class="overlay" href="' + link + '" target="_blank">' +
			`${ctaShowOnHover ? '' : ctaAreaInner}` +
			ctaAreaHover +
			'</a>' +
			'<div class="control-area" style=""></div>' +
			ctaAreaOuter;
	}
	...
	eventTrigger(eventType, params = {}) {
		...
		switch (eventType) {
			...
			case "start":
				...
				var url = this.populateSessionId(this.videoData.eventURLs.videoEventStartURL);
			...
			case "part":
				var url = this.populateSessionId(this.videoData.eventURLs.videoEventPartURL);
			...
			case "complete":
				var url = this.populateSessionId(this.videoData.eventURLs.videoEventCompleteURL);
				this.fetchData(url);
				...
				if (this.videoData.ctaHover && this.videoData.ctaShowOnHover === "t") {
					...
					let wrapper = this.getVideoWrapperElement(this.videoData.styleIdentifier);
					if (wrapper) {
						this.addResponsive(wrapper);
					}
				}
	...
	processPosition(position) {
		...
		if ((seconds % this.videoData.sectionDurationSeconds === 0 || seconds === this.videoData.videoDurationSeconds) && this.sectionsObj) {
			this.sectionsObj.find((obj, index) => {
				if (obj === undefined) {
					return;
				}
				if (obj.end === seconds) {
					if (this.playLog.includes(seconds - this.videoData.sectionDurationSeconds)) {
						this.eventTrigger("part", {
							pn: index + 1, tp: this.sectionsCount, ps: this.videoData.sectionDurationSeconds,
						});
